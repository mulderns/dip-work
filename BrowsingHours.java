...
public class BrowsingHours {
	...
	public static class TokenizerMapper extends Mapper<Object, Text, Text, IntWritable> {
		...
		private Text browsing_hour = new Text();
		...
		public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			...
			if (matcher.matches()) {
				...
				// time: [14/Jun/2014:10:30:13 -0400]
				String hour = time.split(":")[1];

				// split at spaces and get the second fragment
				

				browsing_hour.set(hour);
				context.write(browsing_hour, one);
			}
	...
	public static void main(String[] args) throws Exception {
		...
		if (otherArgs.length < 2) {
			System.err.println("Usage: browsinghours <in> [<in>...] <out>");
			System.exit(2);
		}

		Job job = Job.getInstance(conf, "Product Count");

		job.setJarByClass(BrowsingHours.class);
